// Warm Up: Print out every name in the array shown below
var names = ["Umkulthom", "Roland", "Lisa", "Moussa", "Mamadou", "Nana Ama", "Anissa", "Alana", "Edward", "Raddy", "Le'Moya", "Zuleila", "Brianna", "Saniedy", "Kori", "Mame", "Anthonio", "DeWhyte", "Khaleel", "Khady",
"David", "Kirstyn", "Kadiatu", "Binta", "Blair", "Ryan", "Adrian", "Jaden", "Tajinae", "Kwame", "Pape", "Haji", "Cristin", "Brenayah", "Giandi", "Tishaye", "Naderea", "Samuel", "Aminata", "Nathy", "Laura", "Auris", "Jaden", "Abril", "Jose", "Talayah", "Savannah", "Jadine", "Matthew", "Edward"]





// 1. Add 5 of your favorite songs to the list. Use a for loop to print out each item by saying "I like to listen to Halo", "I like to listen to Crazy in Love", etc.
...
// 2. BRING IT TOGETHER: I have given you a large list of numbers with scores from a recent project. I have made a typo in everyone's grade and they are too large. Divide each grade my 100 to get the actual grade. Print out the correct value to the console.
...
var sizes = [50, 20, 30, 10, 60, 70, 40]
...
function draw() {
	...
	// for(var i = 0; i < colors.length; i++){
	// 	fill(colors[i])
	// 	ellipse(50, 40*i, 50, 50)
	// }
	
	// Question 5
	// for(var i = 0; i < sizes.length; i++){
	// 	ellipse(50 * i, 100, sizes[i], sizes[i])
	// }
	...
	// for(var i = 0; i < sizes.length; i++){
	// 	fill(colors[i])
	// 	ellipse(100, 50 * i, sizes[i], sizes[i])
	// }
